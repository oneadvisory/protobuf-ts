import type { IMessageType, JsonValue } from '@oneadvisory/protobuf-ts-runtime';
import { lowerCamelCase } from '@oneadvisory/protobuf-ts-runtime';
 ...
 * - "options"
 */
export type PartialMethodInfo<
  I extends object = any,
  O extends object = any
> = PartialPartial<
  Omit<MethodInfo<I, O>, 'service'>,
  | 'localName'
  | 'idempotency'
  | 'serverStreaming'
  | 'clientStreaming'
 ...
 */
export function normalizeMethodInfo<
  I extends object = any,
  O extends object = any
>(method: PartialMethodInfo<I, O>, service: ServiceInfo): MethodInfo<I, O> {
  let m = method as any;
  m.service = service;
 ...
 */
export function readMethodOptions<T extends object>(
  service: ServiceInfo,
  methodName: string | number,
  extensionName: string,
  extensionType: IMessageType<T>
): T | undefined {
  const options = service.methods.find(
    (m, i) => m.localName === methodName || i === methodName
  )?.options;
 ...
 * ```
 */
export function readMethodOption<T extends object>(
  service: ServiceInfo,
  methodName: string | number,
  extensionName: string
): JsonValue | undefined;
 ...
 * ```
 */
export function readServiceOption<T extends object>(
  service: ServiceInfo,
  extensionName: string
): JsonValue | undefined;
export function readServiceOption<T extends object>(
