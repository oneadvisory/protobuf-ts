...
export const Proto2OptionalsMessage_TestEnum$stringToNumber = {
    ANY: 0,
    YES: 1,
    NO: 2
} as const;
export const Proto2OptionalsMessage_TestEnum$numberToString = {
    0: "ANY",
    1: "YES",
    2: "NO"
} as const;
...
class Proto2OptionalsMessage$Type extends MessageType<Proto2OptionalsMessage> {
    constructor() {
        super("spec.Proto2OptionalsMessage", [
            ...
            { no: 3, name: "enum_field", kind: "enum", opt: true, T: () => ["spec.Proto2OptionalsMessage.TestEnum", Proto2OptionalsMessage_TestEnum, undefined, Proto2OptionalsMessage_TestEnum$stringToNumber] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional spec.Proto2OptionalsMessage.TestEnum enum_field */ 3:
                    message.enumField = enumNumberToString(Proto2OptionalsMessage_TestEnum$numberToString, reader.int32()) as any;
                    break;
    ...
    internalBinaryWrite(message: Proto2OptionalsMessage, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.enumField !== undefined)
            writer.tag(3, WireType.Varint).int32(enumStringToNumber(Proto2OptionalsMessage_TestEnum$stringToNumber, message.enumField));
