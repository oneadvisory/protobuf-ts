...
export const EnumMapMessage_MyEnum$stringToNumber = {
    ANY: 0,
    YES: 1,
    NO: 2
} as const;
export const EnumMapMessage_MyEnum$numberToString = {
    0: "ANY",
    1: "YES",
    2: "NO"
} as const;
...
class EnumMapMessage$Type extends MessageType<EnumMapMessage> {
    constructor() {
        super("spec.EnumMapMessage", [
            { no: 1, name: "str_enu_field", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "enum", T: () => ["spec.EnumMapMessage.MyEnum", EnumMapMessage_MyEnum, undefined, EnumMapMessage_MyEnum$stringToNumber] } },
            { no: 2, name: "int32_enu_field", kind: "map", K: 5 /*ScalarType.INT32*/, V: { kind: "enum", T: () => ["spec.EnumMapMessage.MyEnum", EnumMapMessage_MyEnum, undefined, EnumMapMessage_MyEnum$stringToNumber] } },
            { no: 3, name: "int64_enu_field", kind: "map", K: 3 /*ScalarType.INT64*/, V: { kind: "enum", T: () => ["spec.EnumMapMessage.MyEnum", EnumMapMessage_MyEnum, undefined, EnumMapMessage_MyEnum$stringToNumber] } }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case 1:
                    ...
                    break;
                case 2:
                    val = enumNumberToString(EnumMapMessage_MyEnum$numberToString, reader.int32()) as any;
                    break;
    ...
    internalBinaryWrite(message: EnumMapMessage, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.strEnuField))
            writer.tag(1, WireType.LengthDelimited).fork().tag(1, WireType.LengthDelimited).string(k).tag(2, WireType.Varint).int32(enumStringToNumber(EnumMapMessage_MyEnum$stringToNumber, message.strEnuField[k])).join();
        /* map<int32, spec.EnumMapMessage.MyEnum> int32_enu_field = 2; */
        for (let k of globalThis.Object.keys(message.int32EnuField))
            writer.tag(2, WireType.LengthDelimited).fork().tag(1, WireType.Varint).int32(parseInt(k)).tag(2, WireType.Varint).int32(enumStringToNumber(EnumMapMessage_MyEnum$stringToNumber, message.int32EnuField[k as any])).join();
        /* map<int64, spec.EnumMapMessage.MyEnum> int64_enu_field = 3; */
        for (let k of globalThis.Object.keys(message.int64EnuField))
            writer.tag(3, WireType.LengthDelimited).fork().tag(1, WireType.Varint).int64(k).tag(2, WireType.Varint).int32(enumStringToNumber(EnumMapMessage_MyEnum$stringToNumber, message.int64EnuField[k])).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
