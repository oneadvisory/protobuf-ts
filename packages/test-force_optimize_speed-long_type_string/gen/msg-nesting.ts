...
export const ParentMessage_ChildMessage_GrandChildMessage_GrandChildEnum$stringToNumber = {
    ANY: 0,
    YES: 1,
    NO: 2
} as const;
export const ParentMessage_ChildMessage_GrandChildMessage_GrandChildEnum$numberToString = {
    0: "ANY",
    1: "YES",
    2: "NO"
} as const;
...
export const ParentMessage_ChildMessage_ChildEnum$stringToNumber = {
    ANY: 0,
    YES: 1,
    NO: 2
} as const;
export const ParentMessage_ChildMessage_ChildEnum$numberToString = {
    0: "ANY",
    1: "YES",
    2: "NO"
} as const;
...
export const ParentMessage_ParentEnum$stringToNumber = {
    ANY: 0,
    YES: 1,
    NO: 2
} as const;
export const ParentMessage_ParentEnum$numberToString = {
    0: "ANY",
    1: "YES",
    2: "NO"
} as const;
...
class ParentMessage$Type extends MessageType<ParentMessage> {
    constructor() {
        super("spec.ParentMessage", [
            ...
            { no: 3, name: "child_enum", kind: "enum", T: () => ["spec.ParentMessage.ChildMessage.ChildEnum", ParentMessage_ChildMessage_ChildEnum, undefined, ParentMessage_ChildMessage_ChildEnum$stringToNumber] },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* spec.ParentMessage.ChildMessage.ChildEnum child_enum */ 3:
                    message.childEnum = enumNumberToString(ParentMessage_ChildMessage_ChildEnum$numberToString, reader.int32()) as any;
                    break;
    ...
    internalBinaryWrite(message: ParentMessage, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.childEnum !== "ANY")
            writer.tag(3, WireType.Varint).int32(enumStringToNumber(ParentMessage_ChildMessage_ChildEnum$stringToNumber, message.childEnum));
