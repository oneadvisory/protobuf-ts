// @generated by protobuf-ts 4.0.0 with parameter server_generic,client_none,optimize_code_size
// @generated from protobuf file "service-example.proto" (package "spec", syntax proto3)
// tslint:disable
import { RpcOutputStream } from "@oneadvisory/protobuf-ts-runtime-rpc";
import { RpcInputStream } from "@oneadvisory/protobuf-ts-runtime-rpc";
