...
class Req$Type extends MessageType<Req> {
  ...
  create(value?: PartialMessage<Req>): Req {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.v = '';
    if (value !== undefined) reflectionMergePartial<Req>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Resp$Type extends MessageType<Resp> {
  ...
  create(value?: PartialMessage<Resp>): Resp {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.v = 0;
    if (value !== undefined) reflectionMergePartial<Resp>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* int32 v = 1; */
    if (message.v !== 0) writer.tag(1, WireType.Varint).int32(message.v);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
  ...
  constructor() {
    super('twirp.clientcompat.ClientCompatMessage', [
      ...
      },
      {
        ...
        kind: 'enum',
        T: () => [
          'twirp.clientcompat.ClientCompatMessage.CompatServiceMethod',
 ...
 */
export const CompatService = new ServiceType(
  'twirp.clientcompat.CompatService',
  [
